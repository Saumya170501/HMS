        ...
        <div className="p-6 space-y-6 max-w-5xl mx-auto">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-secondary text-sm font-mono mt-1">Manage your custom price notifications</p>
                </div>
            ...
            {alerts.length === 0 ? (
                <div className="bg-surface border border-border rounded-xl p-12 text-center">
                    ...
                    <h3 className="text-lg font-medium text-primary mb-2">No Alerts Set</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {alerts.map(alert => (
                        <div key={alert.id} className="bg-surface border border-border rounded-xl p-4 group hover:border-slate-300 dark:hover:border-slate-600 transition-colors relative">
                            <div className="flex justify-between items-start mb-3">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        <div className="font-bold text-primary">{alert.symbol}</div>
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <div className="text-xs text-secondary uppercase font-semibold tracking-wider">Condition</div>
